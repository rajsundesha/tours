...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFqc3VuZGVzaGEiLCJhIjoiY2s3bGd4bTRtMDc4MjNmcGFybWU2YXF6YiJ9.54DSzJH6nv8AynDTT6NBHw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!")); // for reloading the images and page when file uploaded successfully
...
var stripe = Stripe('pk_test_cNqJLv75Bx8ZGX1dEioskvES00FGOd7BEN');
